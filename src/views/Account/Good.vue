<template>
  <div class="page-container">
    ...
    <!--表格内容栏-->
    <kt-table :height="350" permsEdit="account:good:edit" permsDelete="account:good:delete"
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { prop: "goodPrice", label: "商品价格", minWidth: 80 },
        { prop: "unit", label: "商品单位", minWidth: 80 },
        { prop: "stock", label: "商品库存", minWidth: 80 },
        { prop: "feature", label: "商品特性", minWidth: 80 },
        { prop: "salePlan", label: "所属门店", minWidth: 80 },
        { prop: "superior", label: "上架计划", minWidth: 80 },
        { prop: "onShelf", label: "是否上架", minWidth: 80 },
        { prop: "restore", label: "恢复库存", minWidth: 80 },
        {
          prop: "createTime",
          label: "创建时间",
          minWidth: 120,
