  ...
  <div class="page-container">
	...
	<div class="toolbar" style="float:left;padding-top:10px;padding-left:15px;">
		<el-form :inline="true" :model="filters" :size="size">
			<el-form-item>
				<el-input v-model="filters.label" placeholder="商户名称"></el-input>
			</el-form-item>
			<el-form-item>
				<kt-button icon="fa fa-search" :label="$t('action.search')" perms="account:company:view" type="primary" @click="findPage(null)"/>
			</el-form-item>
			<el-form-item>
				<kt-button icon="fa fa-plus" :label="$t('action.add')" perms="account:company:add" type="primary" @click="handleAdd" />
			</el-form-item>
		</el-form>
	</div>
	<!--表格内容栏-->
	<kt-table :height="350" permsEdit="account:company:edit" permsDelete="account:company:delete"
 ...
 uploadSuccess:function(e){
	 ...
	 console.log(this.imgPath); 
		...
		findPage: function (data) {
			...
			//this.pageRequest.columnFilters = {name:'id' ,value:this.dataForm.id}
			// var region={
			// 	name:'regionId',
			// 	value:11
			// }
			...
			// 	value:this.userId
			// }
			//this.pageRequest.conditions = [{name:'id', },{name:'regionId',value:11}]
			//this.pageRequest.columnFilters = {region: {name:'regionId', value:11}}
			//this.pageRequest.columnFilters = {regionId:region,id:user}
			
          //  this.pageRequest.columnFilters = {label: {name:'userId', value:sessionStorage.getItem("userId")}}
            //this.pageRequest.columnFilters = {label: {name:'companyName', value:this.filters.label}}
			//this.pageRequest.regionId=1
